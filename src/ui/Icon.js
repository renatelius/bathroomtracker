...
const PATHS = {
  ...
  // Вперёд/стрелка (для переходов в списке)
  arrowRight: (
    <>
      <Path d="M9.5 5l7 7-7 7" />
    </>
  ),
  // Шеврон вниз (для селекторов)
  chevronDown: (
    <>
  ...
  // Лист (природа/баланс — ЖКТ-семантика)
  leaf: (
    <>
      <Path d="M5 21c-1-9 6-16 15-16 0 9-7 16-15 16z" />
      <Path d="M5 21c3-6 7-10 12-12" />
    </>
  ),
  // Капля (вода/гидратация)
  drop: (
    <>
      <Path d="M12 3s6 6.5 6 11a6 6 0 0 1-12 0c0-4.5 6-11 6-11z" />
    </>
  ),
  // Облако (backup/синхронизация)
  cloud: (
    <>
      <Path d="M7 18a4 4 0 0 1-.5-7.97A5.5 5.5 0 0 1 17.5 9.5 4.5 4.5 0 0 1 17 18z" />
    </>
  ),
  // График/аналитика (столбики)
  chart: (
    <>
      <Path d="M4 20V10M10 20V5M16 20v-7M22 20H2" />
    </>
  ),
  // Настройка-часы (будильник/напоминание alt)
  clock: (
    <>
